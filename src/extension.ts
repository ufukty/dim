...
class ExtensionLifecycleController {
    ...
    constructor(context: vscode.ExtensionContext) {
        ...
        context.subscriptions.push(
            ...
            vscode.commands.registerCommand(
                "dim.enableDimForCurrentEditor",
                this.onCommandReceiveEnableDimForCurrentEditor
            ),
            vscode.commands.registerCommand(
                "dim.toggleDimForCurrentEditor",
                this.onCommandReceiveToggleDimForCurrentEditor
            )
        );
    ...
    onDidChangeTextDocument(event: vscode.TextDocumentChangeEvent): any {
        ...
        if (event.document.uri.path !== this.activeEditor.document.uri.path || event.document.uri.scheme !== "file")
            return;
